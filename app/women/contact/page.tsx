...
import { womenServices } from "@/config/services";
...
export default function WomenContactPage() {
  // Get unique service names for the form
  const serviceNames = womenServices.map(s => s.name);
      ...
      <section className="section-sm bg-women-surface">
        <div className="container-narrow text-center">
          ...
          <p className="text-lg text-women-text-muted">
            Questions? Want to book? We'd love to hear from you!
          </p>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container">
          <div className="mb-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-women-primary/10 transition-colors group-hover:bg-women-primary">
                <Calendar className="h-8 w-8 text-women-primary transition-colors group-hover:text-white" />
              </div>
              <h3 className="mb-2 font-semibold">Book Online</h3>
              <p className="text-sm text-women-text-muted">
            ...
            >
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-women-primary/10 transition-colors group-hover:bg-women-primary">
                <Phone className="h-8 w-8 text-women-primary transition-colors group-hover:text-white" />
              </div>
            ...
            >
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-women-primary/10 transition-colors group-hover:bg-women-primary">
                <MessageCircle className="h-8 w-8 text-women-primary transition-colors group-hover:text-white" />
              </div>
            ...
            >
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-women-primary/10 transition-colors group-hover:bg-women-primary">
                <Mail className="h-8 w-8 text-women-primary transition-colors group-hover:text-white" />
              </div>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <ContactForm section="women" services={serviceNames} />
            </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    <MapPin className="mt-1 h-6 w-6 flex-shrink-0 text-women-primary" />
                    <div>
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-2 inline-flex items-center gap-1 text-sm text-women-primary hover:underline"
                      >
                        Get Directions →
                      </a>
                    </div>
                  ...
                  {/* Hours */}
                  <div className="flex gap-4">
                    <Clock className="mt-1 h-6 w-6 flex-shrink-0 text-women-primary" />
                    <div>
                      <h3 className="mb-2 font-semibold">Opening Hours</h3>
                      <div className="space-y-1 text-sm text-women-text-muted">
                        <p>Tuesday - Friday: {brand.hours.tuesday}</p>
                        <p>Saturday: {brand.hours.saturday}</p>
                        <p>Sunday - Monday: Closed</p>
                      </div>
                      <p className="mt-3 text-sm italic text-women-text-muted">
                        By appointment only
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Map Placeholder */}
                  <div className="overflow-hidden rounded-lg border border-women-border">
                    <div className="aspect-video bg-women-surface">
                      <iframe
                  ...
                  {/* Parking Info */}
                  <div className="rounded-lg bg-women-surface p-4">
